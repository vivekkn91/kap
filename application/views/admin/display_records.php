...
<form action="<?php echo base_url() ?>admin/admin/multiform" method="POST" id="personal-info" class="personal-info">



<img src="../../uploads/<?php echo $row->image_name;  ?>" alt="Girl in a jacket" width="500" height="600">
